...
CREATE external web TABLE e_PART  ( P_PARTKEY     INTEGER ,
                        ...
                        execute 'bash -c "$GPHOME/bin/dbgen -b $GPHOME/bin/dists.dss -T P -s 1 -N 4 -n $((GP_SEGMENT_ID + 1))"'
                        on 4 format 'text' (delimiter '|');
CREATE external web TABLE e_SUPPLIER ( S_SUPPKEY     INTEGER ,
                        ...
                        execute 'bash -c "$GPHOME/bin/dbgen -b $GPHOME/bin/dists.dss -T s -s 1 -N 4 -n $((GP_SEGMENT_ID + 1))"'
                        on 4 format 'text' (delimiter '|');
...
CREATE external web TABLE e_CUSTOMER ( C_CUSTKEY     INTEGER ,
                        ...
                        execute 'bash -c "$GPHOME/bin/dbgen -b $GPHOME/bin/dists.dss -T c -s 1 -N 4 -n $((GP_SEGMENT_ID + 1))"'
                        on 4 format 'text' (delimiter '|');
CREATE external web TABLE e_ORDERS  ( O_ORDERKEY       INT8 ,
                        ...
                        execute 'bash -c "$GPHOME/bin/dbgen -b $GPHOME/bin/dists.dss -T O -s 1 -N 4 -n $((GP_SEGMENT_ID + 1))"'
                        on 4 format 'text' (delimiter '|');
